...
import { copyWithFilter } from "./utils/copy-with-filter";
...
function mapValues<TObject extends object, TMappedValue>(
  obj: TObject,
...
const packageJsonSchema = z.object({
  name: z.string().startsWith("@graphql-schema-filter/"),
...
async function validate(packageEntries: Map<string, PackageEntry>) {
